...
@section('content')
<div class="font-inter min-h-[100vh] bg-white px-[4vw] py-[5vh]">
    <div class="mb-[4vh]">
    ...
    <div class="grid grid-cols-3 gap-[2vw]">
        @foreach ($members as $member)
            <div class="rounded-2xl border border-black bg-indigo-50 p-[2vw] shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
